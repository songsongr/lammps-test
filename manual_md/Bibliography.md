...
:   V. Botu, R. Batra, J. Chapman and R. Ramprasad, [https://arxiv.org/abs/1610.02098](https://arxiv.org/abs/1610.02098){.reference .external} (2016).
...
:   CasP webpage: [https://lief.if.ufrgs.br/pub/CasP/](https://lief.if.ufrgs.br/pub/CasP/){.reference .external}
...
:   Daivis and Todd, Nonequilibrium Molecular Dynamics (book), Cambridge University Press, [https://doi.org/10.1017/9781139017848](https://doi.org/10.1017/9781139017848){.reference .external}, (2017).
...
:   Elliott, Tadmor and Bernstein, [https://openkim.org/kim-api/](https://openkim.org/kim-api/){.reference .external} (2011) doi: [https://doi.org/10.25950/FF8F563A](https://doi.org/10.25950/FF8F563A){.reference .external}
...
:   Gingrich, MSc thesis \<[https://gingrich.chem.northwestern.edu/papers/ThesiswCorrections.pdf](https://gingrich.chem.northwestern.edu/papers/ThesiswCorrections.pdf){.reference .external}\>\` (2010).
...
:   24. Huang, "Exploring critical-state behavior using DEM", Doctoral dissertation, Imperial College. (2014). [https://doi.org/10.25560/25316](https://doi.org/10.25560/25316){.reference .external}
...
:   L.T. Kong, G. Bartels, C. Campana, C. Denniston, and Martin H. Muser, [Computer Physics Communications \[180\](6):1004-1010 (2009).](https://doi.org/10.1016/j.cpc.2008.12.035){.reference .external}

**(Kong2011)**

:   L.T. Kong, [Computer Physics Communications \[182\](10):2201-2207, (2011).](https://doi.org/10.1016/j.cpc.2011.04.019){.reference .external}
...
:   Lafourcade, Maillet, Denoual, Duval, Allera, Goryaeva, and Marinica, [Comp. Mat. Science, 230, 112534 (2023)](https://doi.org/10.1016/j.commatsci.2023.112534){.reference .external}
...
:   Sabry G. Moustafa, Andrew J. Schultz, and David A. Kofke, [Phys. Rev. E \[92\], 043303 (2015)](https://link.aps.org/doi/10.1103/PhysRevE.92.043303){.reference .external}
...
:   Nguyen and Sema, [https://arxiv.org/abs/2405.00306](https://arxiv.org/abs/2405.00306){.reference .external}, (2024).
...
:   Paquay and Kusters, Biophys. J., 110, 6, (2016). preprint available at [arXiv:1411.3019](https://arxiv.org/abs/1411.3019/){.reference .external}.
...
:   18. Roberts (2019) "Evenly Distributing Points in a Triangle." Extreme Learning. [https://extremelearning.com.au/evenly-distributing-points-in-a-triangle/](https://extremelearning.com.au/evenly-distributing-points-in-a-triangle/){.reference .external}
...
:   SRIM webpage: [http://www.srim.org/](http://www.srim.org/){.reference .external}
...
:   Tadmor, Elliott, Sethna, Miller and Becker, JOM, 63, 17 (2011). doi: [https://doi.org/10.1007/s11837-011-0102-6](https://doi.org/10.1007/s11837-011-0102-6){.reference .external}
...
:   Wicaksono, figshare, [https://doi.org/10.6084/m9.figshare.1488628.v1](https://doi.org/10.6084/m9.figshare.1488628.v1){.reference .external} (2015).
...
:   Xie, S.R., Rupp, M. & Hennig, R.G. Ultra-fast interpretable machine-learning potentials. npj Comput Mater 9, 162 (2023). [https://doi.org/10.1038/s41524-023-01092-7](https://doi.org/10.1038/s41524-023-01092-7){.reference .external}
...
:   Wikipedia - Electronic Stopping Power: [https://en.wikipedia.org/wiki/Stopping_power\_%28particle_radiation%29](https://en.wikipedia.org/wiki/Stopping_power_%28particle_radiation%29){.reference .external}
:::
::::
:::::
