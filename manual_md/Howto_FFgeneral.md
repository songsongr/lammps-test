...
::: {#some-general-force-field-considerations .section}
# [10.4.1. ]{.section-number}Some general force field considerations[](#some-general-force-field-considerations "Link to this heading"){.headerlink}

A compact summary of the concepts, definitions, and properties of force fields with explicit bonded interactions (like the ones discussed in this HowTo) is given in [[(Gissinger)]{.std .std-ref}](#typelabel2){.reference .internal}.
