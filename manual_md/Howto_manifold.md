...
::: {#manifolds-surfaces .section}
# [10.5.10. ]{.section-number}Manifolds (surfaces)[](#manifolds-surfaces "Link to this heading"){.headerlink}
...
Below is a list of currently supported manifolds by the MANIFOLD package, their parameters and a short description of them. The parameters listed here are in the same order as they should be passed to the relevant fixes.
  ...
  *manifold*      *parameters*     *equation*                                                                                                                                 *description*
  ...
  thylakoid       wB LB lB         Various, see [[(Paquay)]{.std .std-ref}](#paquay1){.reference .internal}                                                                   A model grana thylakoid consisting of two block-like compartments connected by a bridge of width wB, length LB and taper length lB
