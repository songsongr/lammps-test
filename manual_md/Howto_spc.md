...
:::::::::::::::::: {#spc-and-spc-e-water-model .section}
# [10.4.8. ]{.section-number}SPC and SPC/E water model[](#spc-and-spc-e-water-model "Link to this heading"){.headerlink}

The SPC water model specifies a 3-site rigid water molecule with charges and Lennard-Jones parameters assigned to each of the three atoms. In LAMMPS the [[fix shake]{.doc}]fix_shake.md){.reference .internal} command can be used to hold the two O-H bonds and the H-O-H angle rigid. A bond style of *harmonic* and an angle style of *harmonic* or *charmm* should also be used.
...
::: line
LJ [\\(\\epsilon\\)]{.math .notranslate .nohighlight} of OO = 0.1553
:::

::: line
LJ [\\(\\sigma\\)]{.math .notranslate .nohighlight} of OO = 3.166
:::

::: line
LJ [\\(\\epsilon\\)]{.math .notranslate .nohighlight}, [\\(\\sigma\\)]{.math .notranslate .nohighlight} of OH, HH = 0.0
:::

::: line
[\\(r_0\\)]{.math .notranslate .nohighlight} of OH bond = 1.0
:::

::: line
[\\(\\theta_0\\)]{.math .notranslate .nohighlight} of HOH angle = 109.47[\\(\^{\\circ}\\)]{.math .notranslate .nohighlight}
:::
...
See the [[(Berendsen2)]{.std .std-ref}](#howto-berendsen){.reference .internal} reference for more details on both the SPC and SPC/E models.

Below is the code for a LAMMPS input file and a molecule file ([`spce.mol`{.docutils .literal .notranslate}]{.pre}) of SPC/E water for use with the [[molecule command]{.doc}]molecule.md){.reference .internal} demonstrating how to set up a small bulk water system for SPC/E with rigid bonds. For simplicity and speed the example uses a cutoff Coulomb. Most production simulations require long-range Coulomb instead.
...
:::: {#spce-molecule .highlight-none .notranslate}
::: highlight
