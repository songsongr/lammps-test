...
::: {#body-styles .section}
# [3.15. ]{.section-number}Body styles[](#body-styles "Link to this heading"){.headerlink}
...
See the [[Howto body]{.doc}]Howto_body.md){.reference .internal} page for an overview of using body particles and the various body styles LAMMPS supports. New styles can be created to add new kinds of body particles to LAMMPS.
