...
:::::::::::::: {#angle-style-cosine-command .section}
[]{#index-2}[]{#index-1}[]{#index-0}

# angle_style cosine command[](#angle-style-cosine-command "Link to this heading"){.headerlink}
...
where [\\(K\\)]{.math .notranslate .nohighlight} is defined for each angle type.
