...
:::::::::::::: {#angle-style-cosine-delta-command .section}
[]{#index-1}[]{#index-0}

# angle_style cosine/delta command[](#angle-style-cosine-delta-command "Link to this heading"){.headerlink}
...
[[angle_coeff]{.doc}]angle_coeff.md){.reference .internal}, [[angle_style cosine/squared]{.doc}]angle_cosine_squared.md){.reference .internal}
:::
