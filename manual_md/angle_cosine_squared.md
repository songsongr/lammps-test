...
:::::::::::::: {#angle-style-cosine-squared-command .section}
[]{#index-1}[]{#index-0}

# angle_style cosine/squared command[](#angle-style-cosine-squared-command "Link to this heading"){.headerlink}
...
, which is commonly used in the [[DREIDING]{.doc}]Howto_bioFF.md){.reference .internal} force field, where [\\(\\theta_0\\)]{.math .notranslate .nohighlight} is the equilibrium value of the angle, and [\\(K\\)]{.math .notranslate .nohighlight} is a prefactor. Note that the usual 1/2 factor is included in [\\(K\\)]{.math .notranslate .nohighlight}.

See [[(Mayo)]{.std .std-ref}](#cosine-mayo){.reference .internal} for a description of the DREIDING force field.
