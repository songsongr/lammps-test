...
:::::::::::::: {#angle-style-fourier-simple-command .section}
[]{#index-1}[]{#index-0}

# angle_style fourier/simple command[](#angle-style-fourier-simple-command "Link to this heading"){.headerlink}
...
- [\\(c\\)]{.math .notranslate .nohighlight} (real)

- [\\(n\\)]{.math .notranslate .nohighlight} (real)
