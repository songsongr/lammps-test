...
::::::::::::::: {#compute-rattlers-atom-command .section}
[]{#index-0}

# compute rattlers/atom command[](#compute-rattlers-atom-command "Link to this heading"){.headerlink}
...
The *radius* cutoff option requires that atoms store a radius as defined by the [[atom_style sphere]{.doc}]atom_style.md){.reference .internal} or similar commands.
:::

::: {#related-commands .section}
## Related commands[](#related-commands "Link to this heading"){.headerlink}

[[compute coord/atom]{.doc}]compute_coord_atom.md){.reference .internal} [[compute contact/atom]{.doc}]compute_contact_atom.md){.reference .internal}
:::
