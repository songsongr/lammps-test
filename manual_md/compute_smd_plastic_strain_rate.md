...
::::::::::::: {#compute-smd-plastic-strain-rate-command .section}
[]{#index-0}

# compute smd/plastic/strain/rate command[](#compute-smd-plastic-strain-rate-command "Link to this heading"){.headerlink}
...
The per-particle values will be given in [[units]{.doc}]units.md){.reference .internal} of one over time.
:::
...
[[smd/plastic/strain]{.doc}]compute_smd_plastic_strain.md){.reference .internal}, [[smd/tlsph/strain/rate]{.doc}]compute_smd_tlsph_strain_rate.md){.reference .internal}, [[smd/tlsph/strain]{.doc}]compute_smd_tlsph_strain.md){.reference .internal}
:::
