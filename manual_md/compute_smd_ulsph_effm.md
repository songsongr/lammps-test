...
:::::::::::::: {#compute-smd-ulsph-effm-command .section}
[]{#index-0}

# compute smd/ulsph/effm command[](#compute-smd-ulsph-effm-command "Link to this heading"){.headerlink}
...
The per-particle vector contains the current effective per atom shear modulus as computed by the [[pair smd/ulsph]{.doc}]pair_smd_ulsph.md){.reference .internal} pair style.
:::
...
[[pair smd/ulsph]{.doc}]pair_smd_ulsph.md){.reference .internal}
:::
