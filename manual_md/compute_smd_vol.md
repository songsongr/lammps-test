...
:::::::::::::: {#compute-smd-vol-command .section}
[]{#index-0}

# compute smd/vol command[](#compute-smd-vol-command "Link to this heading"){.headerlink}
...
The per-particle vector values will be given in [[units]{.doc}]units.md){.reference .internal} of volume.
...
[[compute smd/rho]{.doc}]compute_smd_rho.md){.reference .internal}
:::
