...
::::::::::::::: {#dihedral-style-harmonic-command .section}
[]{#index-3}[]{#index-2}[]{#index-1}[]{#index-0}

# dihedral_style harmonic command[](#dihedral-style-harmonic-command "Link to this heading"){.headerlink}
...
- Some force fields reverse the sign convention on [\\(d\\)]{.math .notranslate .nohighlight}.

- Some force fields let [\\(n\\)]{.math .notranslate .nohighlight} be positive or negative which corresponds to [\\(d = 1\\)]{.math .notranslate .nohighlight} or [\\(d = -1\\)]{.math .notranslate .nohighlight} for the harmonic style.
