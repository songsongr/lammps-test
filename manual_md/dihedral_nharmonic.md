...
:::::::::::::: {#dihedral-style-nharmonic-command .section}
[]{#index-2}[]{#index-1}[]{#index-0}

# dihedral_style nharmonic command[](#dihedral-style-nharmonic-command "Link to this heading"){.headerlink}
...
- [\\(A_n\\)]{.math .notranslate .nohighlight} (energy)
