...
::::::::::::::: {#fix-eos-table-command .section}
[]{#index-0}

# fix eos/table command[](#fix-eos-table-command "Link to this heading"){.headerlink}
