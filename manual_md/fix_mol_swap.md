...
:::::::::::::::::: {#fix-mol-swap-command .section}
[]{#index-0}

# fix mol/swap command[](#fix-mol-swap-command "Link to this heading"){.headerlink}
...
[[fix atom/swap]{.doc}]fix_atom_swap.md){.reference .internal}, [[fix gcmc]{.doc}]fix_gcmc.md){.reference .internal}
:::
