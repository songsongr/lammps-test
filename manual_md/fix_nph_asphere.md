...
:::::::::::::::: {#fix-nph-asphere-command .section}
[]{#index-1}[]{#index-0}

# fix nph/asphere command[](#fix-nph-asphere-command "Link to this heading"){.headerlink}
...
[[fix nph]{.doc}]fix_nh.md){.reference .internal}, [[fix nve_asphere]{.doc}]fix_nve_asphere.md){.reference .internal}, [[fix nvt_asphere]{.doc}]fix_nvt_asphere.md){.reference .internal}, [[fix npt_asphere]{.doc}]fix_npt_asphere.md){.reference .internal}, [[fix_modify]{.doc}]fix_modify.md){.reference .internal}
:::
