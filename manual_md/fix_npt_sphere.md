...
:::::::::::::::: {#fix-npt-sphere-command .section}
[]{#index-1}[]{#index-0}

# fix npt/sphere command[](#fix-npt-sphere-command "Link to this heading"){.headerlink}
...
- ID, group-ID are documented in [[fix]{.doc}]fix.md){.reference .internal} command npt/sphere = style name of this fix command zero or more keyword/value pairs may be appended
...
- NOTE: additional thermostat and barostat and dipole related keyword/value pairs from the [[fix npt]{.doc}]fix_nh.md){.reference .internal} command can be appended
:::::
...
[[fix npt]{.doc}]fix_nh.md){.reference .internal}, [[fix nve_sphere]{.doc}]fix_nve_sphere.md){.reference .internal},

:   [[fix nvt_sphere]{.doc}]fix_nvt_sphere.md){.reference .internal}, [[fix npt_asphere]{.doc}]fix_npt_asphere.md){.reference .internal}, [[fix_modify]{.doc}]fix_modify.md){.reference .internal}
:::
