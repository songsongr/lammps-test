...
:::::::::::::: {#fix-nve-body-command .section}
[]{#index-0}

# fix nve/body command[](#fix-nve-body-command "Link to this heading"){.headerlink}
...
[[fix nve]{.doc}]fix_nve.md){.reference .internal}, [[fix nve/sphere]{.doc}]fix_nve_sphere.md){.reference .internal}, [[fix nve/asphere]{.doc}]fix_nve_asphere.md){.reference .internal}
:::
