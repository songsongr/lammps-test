...
:::::::::::::: {#fix-nve-line-command .section}
[]{#index-0}

# fix nve/line command[](#fix-nve-line-command "Link to this heading"){.headerlink}
...
This fix requires that particles be line segments as defined by the [[atom_style line]{.doc}]atom_style.md){.reference .internal} command.
:::
