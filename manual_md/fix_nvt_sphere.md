...
:::::::::::::::: {#fix-nvt-sphere-command .section}
[]{#index-1}[]{#index-0}

# fix nvt/sphere command[](#fix-nvt-sphere-command "Link to this heading"){.headerlink}
...
- NOTE: additional thermostat and dipole related keyword/value pairs from the [[fix nvt]{.doc}]fix_nh.md){.reference .internal} command can be appended
:::::
...
See the [[compute temp/sphere]{.doc}]compute_temp_sphere.md){.reference .internal} command for details. Note that the ID of the new compute is the fix-ID + underscore + "temp", and the group for the new compute is the same as the fix group.
...
[[fix nvt]{.doc}]fix_nh.md){.reference .internal}, [[fix nve_sphere]{.doc}]fix_nve_sphere.md){.reference .internal},

:   [[fix nvt_asphere]{.doc}]fix_nvt_asphere.md){.reference .internal}, [[fix npt_sphere]{.doc}]fix_npt_sphere.md){.reference .internal}, [[fix_modify]{.doc}]fix_modify.md){.reference .internal}
:::
