...
::::::::::::::::: {#fix-store-state-command .section}
[]{#index-0}

# fix store/state command[](#fix-store-state-command "Link to this heading"){.headerlink}
...
The list of possible attributes is the same as that used by the [[dump custom]{.doc}]dump.md){.reference .internal} command, which describes their meaning.
...
[[dump custom]{.doc}]dump.md){.reference .internal}, [[compute property/atom]{.doc}]compute_property_atom.md){.reference .internal}, [[fix property/atom]{.doc}]fix_property_atom.md){.reference .internal}, [[variable]{.doc}]variable.md){.reference .internal}
:::
