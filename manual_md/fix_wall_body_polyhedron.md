...
:::::::::::::::: {#fix-wall-body-polyhedron-command .section}
[]{#index-0}

# fix wall/body/polyhedron command[](#fix-wall-body-polyhedron-command "Link to this heading"){.headerlink}
...
The parameters *k_n*, *c_n*, *c_t* have the same meaning and units as those specified with the [[pair_style body/rounded/polyhedron]{.doc}]pair_body_rounded_polyhedron.md){.reference .internal} command.
...
[[atom_style body]{.doc}]atom_style.md){.reference .internal}, [[pair_style body/rounded/polyhedron]{.doc}]pair_body_rounded_polyhedron.md){.reference .internal}
:::
