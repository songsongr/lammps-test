...
::: {#group2ndx-command .section}
[]{#index-1}[]{#index-0}

# group2ndx command[](#group2ndx-command "Link to this heading"){.headerlink}
:::

:::::::::::::::: {#ndx2group-command .section}
# ndx2group command[](#ndx2group-command "Link to this heading"){.headerlink}
...
Write or read a Gromacs style index file in text format that associates atom IDs with the corresponding group definitions. This index file can be used with in combination with Gromacs analysis tools or to import group definitions into the [[fix colvars]{.doc}]fix_colvars.md){.reference .internal} input file.
...
::::: {#file-format .section}
## File Format[](#file-format "Link to this heading"){.headerlink}

The file format is equivalent and compatible with what is produced by the [Gromacs make_ndx command](https://manual.gromacs.org/current/onlinehelp/gmx-make_ndx.html){.reference .external}. and follows the [Gromacs definition of an ndx file](https://manual.gromacs.org/current/reference-manual/file-formats.html#ndx){.reference .external}
...
These commands are part of the EXTRA-COMMAND package. They are only enabled if LAMMPS was built with that package. See the [[Build package]{.doc}]Build_package.md){.reference .internal} page for more info.
:::

::: {#related-commands .section}
## Related commands[](#related-commands "Link to this heading"){.headerlink}

[[group]{.doc}]group.md){.reference .internal}, [[dump]{.doc}]dump.md){.reference .internal}, [[fix colvars]{.doc}]fix_colvars.md){.reference .internal}
:::
