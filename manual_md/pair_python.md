...
::::::::::::::::::::::::::::::::::: {#pair-style-python-command .section}
[]{#index-0}

# pair_style python command[](#pair-style-python-command "Link to this heading"){.headerlink}
...
The class constructor has to set up a data structure containing the potential parameters supported by this class. It should also define a variable *self.units* containing a string matching one of the options of LAMMPS' [[units]{.doc}]units.md){.reference .internal} command, which is used to verify, that the potential definition in the python class and in the LAMMPS input match.
:::
...
[[pair_coeff]{.doc}]pair_coeff.md){.reference .internal}, [[pair_write]{.doc}]pair_write.md){.reference .internal}, [[pair style table]{.doc}]pair_table.md){.reference .internal}
:::
