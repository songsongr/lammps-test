...
:::::::::::::::: {#pair-style-sph-taitwater-command .section}
[]{#index-1}[]{#index-0}

# pair_style sph/taitwater command[](#pair-style-sph-taitwater-command "Link to this heading"){.headerlink}
...
This pair style also computes Monaghan's artificial viscosity to prevent particles from interpenetrating [[(Monaghan)]{.std .std-ref}](#monaghan){.reference .internal}.
