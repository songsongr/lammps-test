...
:::::::::::::::::: {#restart-command .section}
[]{#index-0}

# restart command[](#restart-command "Link to this heading"){.headerlink}
...
Similar to [[dump]{.doc}]dump.md){.reference .internal} files, the restart filename(s) can contain two wild-card characters.
...
See the [[read_restart]{.doc}]read_restart.md){.reference .internal} command for information about what is stored in a restart file.
...
[[write_restart]{.doc}]write_restart.md){.reference .internal}, [[read_restart]{.doc}]read_restart.md){.reference .internal}
:::
